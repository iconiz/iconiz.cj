...
@Injectable()
export class IconizTeamMemberServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(): Observable<IconizTeamMember[]> {
        let url_ = this.baseUrl + "/api/services/app/IconizTeamMember/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<IconizTeamMember[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<IconizTeamMember[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<IconizTeamMember[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(IconizTeamMember.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<IconizTeamMember[]>(<any>null);
    }
     ...
     * @return Success
     */
    getIconizTeamMembers(userName: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfIconizTeamMemberListDto> {
        let url_ = this.baseUrl + "/api/services/app/IconizTeamMember/GetIconizTeamMembers?";
        if (userName !== undefined)
            url_ += "UserName=" + encodeURIComponent("" + userName) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetIconizTeamMembers(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetIconizTeamMembers(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfIconizTeamMemberListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfIconizTeamMemberListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetIconizTeamMembers(response: HttpResponseBase): Observable<PagedResultDtoOfIconizTeamMemberListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfIconizTeamMemberListDto.fromJS(resultData200) : new PagedResultDtoOfIconizTeamMemberListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfIconizTeamMemberListDto>(<any>null);
    }
     ...
     * @return Success
     */
    getIconizTeamMemberForEdit(id: number | null | undefined): Observable<TeamMemberEditDto> {
        let url_ = this.baseUrl + "/api/services/app/IconizTeamMember/GetIconizTeamMemberForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetIconizTeamMemberForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetIconizTeamMemberForEdit(<any>response_);
                } catch (e) {
                    return <Observable<TeamMemberEditDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TeamMemberEditDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetIconizTeamMemberForEdit(response: HttpResponseBase): Observable<TeamMemberEditDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? TeamMemberEditDto.fromJS(resultData200) : new TeamMemberEditDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TeamMemberEditDto>(<any>null);
    }
     ...
     * @return Success
     */
    createOrUpdateIconizTeamMember(input: TeamMemberEditDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/IconizTeamMember/CreateOrUpdateIconizTeamMember";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrUpdateIconizTeamMember(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrUpdateIconizTeamMember(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateOrUpdateIconizTeamMember(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteIconizTeamMember(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/IconizTeamMember/DeleteIconizTeamMember?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteIconizTeamMember(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteIconizTeamMember(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
...
export class IconizTeamMember implements IIconizTeamMember {
    ...
    name_Chn!: string | undefined;
    name_Eng!: string | undefined;
    title_Chn!: string | undefined;
    title_Eng!: string | undefined;
    description_Chn!: string | undefined;
    ...
    constructor(data?: IIconizTeamMember) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.name_Chn = data["name_Chn"];
            this.name_Eng = data["name_Eng"];
            this.title_Chn = data["title_Chn"];
            this.title_Eng = data["title_Eng"];
            this.description_Chn = data["description_Chn"];
    ...
    static fromJS(data: any): IconizTeamMember {
        data = typeof data === 'object' ? data : {};
        let result = new IconizTeamMember();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["name_Chn"] = this.name_Chn;
        data["name_Eng"] = this.name_Eng;
        data["title_Chn"] = this.title_Chn;
        data["title_Eng"] = this.title_Eng;
        data["description_Chn"] = this.description_Chn;
...
export interface IIconizTeamMember {
    userId: number | undefined;
    priority: number | undefined;
    name_Chn: string | undefined;
    name_Eng: string | undefined;
...
export class PagedResultDtoOfIconizTeamMemberListDto implements IPagedResultDtoOfIconizTeamMemberListDto {
    totalCount!: number | undefined;
    items!: IconizTeamMemberListDto[] | undefined;

    constructor(data?: IPagedResultDtoOfIconizTeamMemberListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(IconizTeamMemberListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfIconizTeamMemberListDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfIconizTeamMemberListDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfIconizTeamMemberListDto {
    totalCount: number | undefined;
    items: IconizTeamMemberListDto[] | undefined;
}

export class IconizTeamMemberListDto implements IIconizTeamMemberListDto {
    name_Chn!: string | undefined;
    name_Eng!: string | undefined;
    priority!: number | undefined;
    isActive!: boolean | undefined;
    ...
    constructor(data?: IIconizTeamMemberListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): IconizTeamMemberListDto {
        data = typeof data === 'object' ? data : {};
        let result = new IconizTeamMemberListDto();
        result.init(data);
        return result;
    }
...
export interface IIconizTeamMemberListDto {
    name_Chn: string | undefined;
    name_Eng: string | undefined;
    priority: number | undefined;
    isActive: boolean | undefined;
...
export class TeamMemberEditDto implements ITeamMemberEditDto {
    id!: number | undefined;
    userId!: number | undefined;
    priority!: number | undefined;
    name_Chn!: string | undefined;
    ...
    constructor(data?: ITeamMemberEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TeamMemberEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new TeamMemberEditDto();
        result.init(data);
        return result;
    }
...
export interface ITeamMemberEditDto {
    id: number | undefined;
    userId: number | undefined;
    priority: number | undefined;
    name_Chn: string | undefined;
